...
#-------------------------------------
set terminal pdf
set out "j_index_networking.pdf"
i="./../results/"
ifilefd=i."jain_perclass_2_fairnet_64.dat"
ifiletd=i."jain_perclass_2_tailnet_64.dat"
#
...
set xlab  " "
plot \
ifilefd u ($1/350):6 w p lw 1 pt ec lc rgb "blue" title "{CPU Cycles}",\
ifilefd u ($1/350):4  w p lw 1 pt es lc rgb "blue" title "{Throughput}",\
...
plot \
ifiletd u ($1/350):6 w p lw 1 pt fc lc rgb 'red' title "{CPU Cycles}",\
ifiletd u ($1/350):4  w p lw 1 pt fs lc rgb "red" title "{Throughput}",\
J(x) w l lt -1 lw 2 title ""
