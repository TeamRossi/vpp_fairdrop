...
set out "figure4_networking.pdf"
...
plot \
'./../results/FAIRDROP_BW_SINGLECORE_0.1/flow_pps.dat'    	u ($0):1   	t 'FD  ({/Symbol a}=0.1)'  	w  lp pt ec lc rgb "red", \
'./../results/TAILDROP_BW_SINGLECORE_0.1/flow_pps.dat'	u ($0):1   	t 'TD  ({/Symbol a}=0.1)'	w  lp pt fc lc rgb "red", \
'./../results/FAIRDROP_BW_SINGLECORE_0.4/flow_pps.dat'    	u ($0):1   	t 'FD  ({/Symbol a}=0.4)'  	w  lp pt ec lc rgb "blue", \
'./../results/TAILDROP_BW_SINGLECORE_0.4/flow_pps.dat'	u ($0):1   	t 'TD  ({/Symbol a}=0.4)'	w  lp pt fc lc rgb "blue", \
'./../results/FAIRDROP_BW_SINGLECORE_0.6/flow_pps.dat'   		u ($0):1   	t 'FD  ({/Symbol a}=0.6)'  	w  lp pt ec lc rgb "black", \
'./../results/TAILDROP_BW_SINGLECORE_0.6/flow_pps.dat'	u ($0):1   	t 'TD  ({/Symbol a}=0.6)'	w  lp pt fc lc rgb "black"
