sudo $VPP_ROOT/build-root/install-vpp-native/vpp/bin/vpp unix {nodaemon} cpu { main-core $1 corelist-workers $2 $3 corelist-hqos-threads $4} api-segment {prefix vpp2} dpdk { dev $5 {num-rx-queues 2 num-rx-desc 2048 } dev $6 {num-rx-queues 2 num-rx-desc 2048 hqos} socket-mem 8192,8192} plugin_path $VPP_ROOT/build-root/install-vpp-native/vpp/lib64/vpp_plugins
